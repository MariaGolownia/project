...
<div class="container">
    ...
    <form class="form-signin" action="Controller?command=registration_page_admin" method="post">
        ...
        <input type="login" id="inputLogin" name="userLogin" class="form-control" placeholder="Enter your login" value="${login_user}" required autofocus>
        <!---------------------------------------Password----------------------------------------------------------------->
